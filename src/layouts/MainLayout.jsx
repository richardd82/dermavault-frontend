...
export default function MainLayout() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-center gap-4 h-[70px] p-4 text-xl font-bold bg-[#a78bfa] text-white">
      ...
      <div className="flex flex-col flex-1">
        ...
        <header className="flex items-center justify-between px-4 py-3 md:px-6 md:py-4 bg-white dark:bg-[#2a2b2f] border-b border-gray-200 dark:border-gray-700">
          ...
          {/* Usuario + toggle */}
          <div className="flex items-center gap-4">
            <span className="text-sm md:text-base font-medium">{user?.username}</span>
            <ThemeToggle />
          </div>
        </header>
...
//   return (
//     <div className={`flex h-screen bg-[#f8f9fa] text-[#1f2937] dark:bg-[#1a1b1e] dark:text-[#e5e7eb] transition-colors duration-500 ${theme}` }>
//       {/* Sidebar izquierdo */}
//       <aside className="w-[300px] bg-[#f8f9fa] dark:bg-[#2a2b2f] border-r border-gray-200 dark:border-gray-700 flex flex-col">
//         <div className=" flex justify-center items-center h-[70px] gap-7 p-4 text-xl font-bold bg-[#a78bfa] dark:bg-[#a78bfa] text-[#f8f9fa]">
//          <img src={logoImg} alt="Logo DermaVault" className="w-16 h-16" /> DermaVault
//         </div>
//         <Sidebar />
//       </aside>
...
//                 type="text"
//                 placeholder="Buscar paciente..."
//                 className="pl-10 pr-4 py-2 rounded-md bg-[#f8f9fa] dark:bg-[#1f2023] border border-gray-300 dark:border-gray-600 text-sm w-72 focus:outline-none focus:ring-2 focus:ring-[#4f46e5]"
//               />
//               <FaSearch className="absolute top-2.5 left-3 text-gray-500 dark:text-gray-400" />
//             </div>
//           </div>
