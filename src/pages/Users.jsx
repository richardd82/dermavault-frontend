  ...
  return (
    <div className="p-4 md:p-6 w-full">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        ...
        <button className="bg-[#4f46e5] dark:bg-[#a78bfa] text-white px-4 py-2 rounded-lg hover:opacity-90 transition text-sm font-medium" onClick={() => setShowModal(true)}>
          + Nuevo Usuario
        </button>
      </div>
        ...
        <table className="min-w-full bg-white dark:bg-[#2a2b2f] rounded-lg shadow-md">
          ...
          <tbody>
            {users.map((u, index) => (
              <tr
                key={index}
                className="border-b border-gray-100 dark:border-gray-700 hover:bg-[#f3f4f6] dark:hover:bg-[#1f2023] transition"
              >
      ...
      <Modal isOpen={showModal} onClose={() => setShowModal(false)} title="Agregar nuevo usuario">
